...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://neondb_owner:npg_BioAJRwd90UD@ep-blue-lab-adbqcc1d-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require' # <--- هذا هو السطر الصحيح الآن
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
app.config['SECRET_KEY'] = 'your_super_secret_key_here_for_production_use_a_strong_one' # غيّر هذا المفتاح السري!
